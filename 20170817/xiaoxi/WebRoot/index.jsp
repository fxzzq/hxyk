...
<form action="deal_order.jsp" method="post" name="theForm" id="theForm"  target="_blank" >
    ...
    <h6>收货信息</h6>
        <div class="paykind_box01" id="checkout_form_box">
            <ul>
                <li>
                    <label>收货人姓名：</label>
                    <input class="col_c" value="请输入收货人姓名" dvalue="请输入收货人姓名" name="name" id="name" onblur="consigneeSet(this.value)" size="30">
...
<script type="text/javascript" src="js/bddq.js" charset="gb2312"></script>
                <li>
                    <label>地址：</label>
                     <select name="bdprovince" class="bddqxl"></select>
                                                      省份/直辖市
				     <select name="bdcity" class="bddqxl"></select>
				            市
					 <select name="bdarea" class="bddqxl"></select>
...
<script type="text/javascript" src="js/bdbd.js"></script>
                ...
                <li>
                    <label></label>
                    <input class="col_c" style="width:310px" name="address" id="xdz" onblur="addressSet(this.value)" size="40" maxlength="120" value="请填写详细地址" dvalue="请填写详细地址" type="text">
                    <span id="address_notice"></span>
                </li>
                
                <li>
                    <label>联系电话：</label>
                    <input class="col_c" value="手机号或区号-固话" dvalue="手机号或区号-固话" name="mob" id="tel" maxlength="13"  size="30">
...
<script type="text/javascript" src="get_prevent_refresh867b.html?t=1441175749"></script>
    ...
    <span id="pay_id_notice"></span>
         ...
         <input onclick="this.submit()"  src="picture/click_btn04.jpg" type="image">
         </div>
        </div>
