...
<html>
 ...
 <br> <br> <br>
   <p align="center" style="background:blue"><font color="#ffffff">管理员管理</font> </p>
	...
	String passname;//传到modifyPwd.jsp和deleteuser.jsp
		int id;
		String name;
	String pwd;
	//将查询结果集中的记录输出到页面上  
		while (rs.next()) {
			...
			out.println("<td align='center'><a href='modifyPwd.jsp?passname=" + name+ "'>修改密码</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='deleteuser.jsp?passname=" + name+ "' onclick='confirm_delete()'>删除</a></td>");
